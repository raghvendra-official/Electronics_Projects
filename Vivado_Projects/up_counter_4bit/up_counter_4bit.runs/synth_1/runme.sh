...
HD_PWD='C:/Users/raghv/OneDrive/Desktop/Vivado/up_counter_4bit/up_counter_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log up_counter_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source up_counter_4bit.tcl
