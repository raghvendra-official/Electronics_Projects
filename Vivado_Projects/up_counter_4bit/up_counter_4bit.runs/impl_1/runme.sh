...
HD_PWD='C:/Users/raghv/OneDrive/Desktop/Vivado/up_counter_4bit/up_counter_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log up_counter_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source up_counter_4bit.tcl -notrace
